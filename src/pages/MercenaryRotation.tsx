    ...
    <div className="ar-root" data-theme={theme}>
      ...
      <section>
        ...
        <div className="call">
          ...
          <p>Parse 3 explains why: below roughly <b>20–25% target health, Volatile Warhead's regen rate roughly doubles</b> — mean gap 9.8 s above that band versus 3.8 s below it, measured proc-by-proc against cumulative damage dealt. That's why cycles late in that fight sometimes catch two or even three procs (rows 14, 16, 18 in the parse 3 grid, section 08) — not better play, just the execute band delivering procs faster than a single cycle can spend them. An early double-proc cycle (row 3, at 84% health) is ordinary timing variance, not this effect — the acceleration only shows up once the target is genuinely low.</p>
        </div>

        <div className="call">
          <h4>A skipped Mag Shot isn't lost — it waits for the next cycle</h4>
          <p>Four of the five parse-3 cycles that land zero Missile Blast in their flex slots (section 08) instead spend their final slot — normally a free Mag Shot — on a Missile Blast that arrived just in time. That Mag Shot doesn't go to waste: <b>Innovative Particle Accelerator's buff, granted by the Power Shot just before it, doesn't expire or get consumed by anything else.</b> It survives straight through the next Incendiary Missile cast and gets spent as the very first flex slot (F1) of the following cycle instead. Confirmed directly in the log — the buff is applied at that Power Shot and isn't removed until the moment the next cycle's F1 Mag Shot fires, several seconds and a full cycle-boundary later.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="gridwrap">
          <div className="cgrid">
            ...
            <div className="crow"><div className="cyc">13</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic sccmark" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic nil" aria-hidden="true"></span><span className="ic rcmark" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg><i className="markflag" data-n="Vent Heat fires here" aria-hidden="true"></i></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.91</div><div className="stk ">9</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">14</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.02</div><div className="stk ">9</div><div className="scc yes">●</div></div>
            <div className="crow bestrow"><div className="cyc">15</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.05</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            ...
            <div className="crow bestrow"><div className="cyc">20</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic rcmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Vent Heat fires here" aria-hidden="true"></i></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic sccmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">final</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
          </div>
        </div>
        ...
        <p className="lede">Numbered from the first steady cycle after the opener, same as the grid above. Note how often <b>Mag Shot fills the F1 slot</b> instead of a real filler — a zero-Supercharge pick this page's model doesn't recommend, yet 17 of these 19 cycles still clear the cap thanks to Serrated Shot's own stack (section 03).</p>
        <div className="gridwrap">
          <div className="cgrid">
            <div className="crow chead">
              <div>#</div><div>IR</div><div>F1</div><div>CB</div><div>SB</div><div>F2</div><div>F3</div><div>F4</div>
            ...
            <div className="crow"><div className="cyc">1</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Unload" role="img" aria-label="Unload"><svg viewBox="0 0 50 50"><use href="#i-fa"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic rcmark" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg><i className="markflag" data-n="Vent Heat fires here" aria-hidden="true"></i></span><div className="len">14.21</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">2</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic sccmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.16</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">3</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic sccmark" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><div className="len">14.48</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow flagrow"><div className="cyc">4</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><div className="len">14.10</div><div className="stk low">9</div><div className="scc no">○</div></div>
            <div className="crow"><div className="cyc">5</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic sccmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.59</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">6</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic sccmark" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.11</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">7</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Electro Net" role="img" aria-label="Electro Net"><svg viewBox="0 0 50 50"><use href="#i-en"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Unload" role="img" aria-label="Unload"><svg viewBox="0 0 50 50"><use href="#i-fa"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><div className="len">14.20</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">8</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic rcmark" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg><i className="markflag" data-n="Vent Heat fires here" aria-hidden="true"></i></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.51</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">9</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic sccmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.22</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow flagrow"><div className="cyc">10</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.30</div><div className="stk low">9</div><div className="scc no">○</div></div>
            <div className="crow"><div className="cyc">11</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic sccmark" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.09</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">12</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic sccmark" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.11</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">13</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Electro Net" role="img" aria-label="Electro Net"><svg viewBox="0 0 50 50"><use href="#i-en"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic sccmark" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.20</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">14</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic sccmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><div className="len">14.56</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">15</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic rcmark" data-n="Unload" role="img" aria-label="Unload"><svg viewBox="0 0 50 50"><use href="#i-fa"/></svg><i className="markflag" data-n="Vent Heat fires here" aria-hidden="true"></i></span><span className="ic nil" aria-hidden="true"></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><div className="len">14.39</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">16</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><div className="len">14.00</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">17</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.01</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">18</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic" data-n="Rapid Shots" role="img" aria-label="Rapid Shots"><svg viewBox="0 0 50 50"><use href="#i-hs"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic sccmark" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><div className="len">14.10</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
            <div className="crow"><div className="cyc">19</div><span className="ic" data-n="Incendiary Missile" role="img" aria-label="Incendiary Missile"><svg viewBox="0 0 50 50"><use href="#i-ir"/></svg></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg></span><span className="ic" data-n="Serrated Shot" role="img" aria-label="Serrated Shot"><svg viewBox="0 0 50 50"><use href="#i-sb"/></svg></span><span className="ic" data-n="Electro Net" role="img" aria-label="Electro Net"><svg viewBox="0 0 50 50"><use href="#i-en"/></svg></span><span className="ic" data-n="Missile Blast" role="img" aria-label="Missile Blast"><svg viewBox="0 0 50 50"><use href="#i-er"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Thermal Detonator" role="img" aria-label="Thermal Detonator"><svg viewBox="0 0 50 50"><use href="#i-ap"/></svg></span><span className="ic nil" aria-hidden="true"></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><span className="ic sccmark" data-n="Power Shot" role="img" aria-label="Power Shot"><svg viewBox="0 0 50 50"><use href="#i-cb"/></svg><i className="markflag" data-n="Supercharged Gas fires here" aria-hidden="true"></i></span><span className="ic" data-n="Mag Shot" role="img" aria-label="Mag Shot"><svg viewBox="0 0 50 50"><use href="#i-mb"/></svg></span><div className="len">14.20</div><div className="stk ten">10</div><div className="scc yes">●</div></div>
          </div>
        </div>
        <div className="markkey">
          <span><i className="bar" style={{ background: 'var(--brass)' }}></i>
        ...
        <p style={{ marginTop: '20px' }}>Filler slots across these 19 cycles: <strong>Rapid Shots 17 (31%), Missile Blast 15 (28%), Power Shot 7 (13%), Mag Shot 9 (17%, always in the F1 slot), Electro Net 3, Unload 3</strong>. 17 of 19 clear the cap — only rows 4 and 10 top out at 9, both landing a single Missile Blast against two ordinary fillers.</p>
      </section>
      ...
      <section>
        ...
        <div className="call flag">
          <h4>5 · Vent Heat: a heat-budget reset, not an Unload combo</h4>
          <p>The ability works as advertised — its buff zeroes heat generation and refunds extra on whatever's cast immediately next — confirmed directly from the buff's own apply/remove timestamps in a third parse. But across all three mid-fight Vent Heat casts there, that buff never once landed on Unload. It went to Incendiary Missile (the next cycle's opener), to Missile Blast (cast 1 ms later), and once to Thermal Detonator — because that Vent Heat was pressed at the exact instant Unload's own channel finished, a beat too late to help it. The commonly-cited advice to fire Vent Heat right before a channeled ability like Unload isn't what's happening in this log.</p>
          <p>What the log does support: the two cycles immediately before the real Vent Heat casts run <b>zero Rapid Shots</b> in their flex slots — every filler pick in both is a heat-costly one. That fits a simpler model than a per-ability combo: treat Vent Heat as a periodic heat-budget reset rather than a setup move, and spend heat more freely in the run-up to it rather than holding a specific ability in reserve. Parse 3's own gaps (93.8 s, 101.0 s) land close to parse 2's independently-inferred 98.3 s interval above — three separate estimates converging on roughly a <b>95–100 s cooldown</b>, still worth confirming directly in-game. If you can see Vent Heat's cooldown ticking down, that's the moment to lean into Missile Blast and Power Shot over Rapid Shots, knowing the reset is close.</p>
        </div>
        ...
        <ul>
          ...
          <li><b>Unload as a proc-down fallback</b> — confirmed in a third parse: a full channel outdamages two ordinary fillers when Volatile Warhead has no proc up (~56,000 vs ~31,000). Not set up with Vent Heat, though — see item 5 above.</li>
