  ...
  return (
    <div className="ar-root" data-theme={theme}>
      ...
      <div className="mast">
        ...
        <p className="standfirst">Both parses share the identical <strong>Squelch 4/8/12</strong> clock and the same fixed Sever Force + Force Breach open. The DPS gap isn't just variance: parse 2 opens from stealth and re-enters it three more times to trigger <strong>Shadowcraft</strong>, landing four 6-second windows of guaranteed critical hits that parse 1 never touches at all.</p>
        <dl className="facts">
      ...
      <section>
        ...
        <p className="lede">Parse 2 starts already in stealth and opens with Shadow Stride into Force in Balance rather than Squelch. That single choice lands a 51,207-damage opening hit — nearly five times any other single hit in the fight — because Shadowcraft is active from the very first GCD.</p>

        <figure>
          <svg viewBox="0 0 820 200" role="img" aria-label="Opener: Shadow Stride from stealth at 0.037 seconds triggers Shadowcraft, Force in Balance lands a 51207 damage critical hit, then Sever Force at 1.4 seconds and Force Breach at 2.8 seconds, then the first steady cycle from roughly 16 seconds.">
            ...
            <g><title>Shadow Stride (from stealth, triggers Shadowcraft)</title><use href="#h-ps" x="16" y="46" width="30" height="30"/></g>
            <g><title>Force in Balance (51,207 damage, guaranteed crit)</title><use href="#h-df" x="60" y="34" width="50" height="50"/></g>
          ...
          <figcaption>Timestamps: Shadow Stride 0.037 (from stealth) · Force in Balance 0.037 (51,207 damage) · Sever Force 1.397 · Force Breach 2.798 · Crush Spirit procs at 4.315 (off the Sever Force tick) · Spinning Strike 7.465 · Squelch 8.851, inside the first Shadowcraft window (section 03). Parse 1 opens with Squelch instead, from full Force, with no stealth and no Shadowcraft — see the original opener sequence preserved in the footer.</figcaption>
        </figure>
      </section>
      ...
      <section>
        ...
        <p className="lede">Parse 2 re-enters stealth four times mid-fight — Force Cloak to vanish, then Shadow Stride back onto the target — to trigger Shadowcraft, which the ability guide describes as "increases your critical chance by 100% for 6 seconds." Parse 1 never does this once. This is the single largest mechanical difference between the two parses.</p>
