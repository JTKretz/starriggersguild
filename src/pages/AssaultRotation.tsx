  ...
  return (
    <div className="ar-root" data-theme={theme}>
      ...
      <section>
        ...
        <div className="call">
          <h4>How far does "use Full Auto more" actually go?</h4>
          <p>Since Supercharge is a running total rather than a per-cycle budget, the right way to model heavier Full Auto use is: how much total generation would it remove from the fight, since total generation ÷ 10 ≈ total pops. Parse 3 generated 190 Supercharge points across 18 pops (180 consumed, ~10 leftover at death) — so removing 10 points of generation costs roughly <b>one pop</b>, worth about <b>121,000 damage</b> (the Supercharged Cell burn is 21.8% of this parse's total).</p>
          <p>The five cycles in the parse 3 grid (section 08) whose flex pair never sees an Explosive Round at all — rows 2, 3, 4, 12, 14 — generate <b>147,768</b> combined damage from ordinary fillers and <b>+10</b> Supercharge. Swap all five for Full Auto (avg 56,053 each): <b>280,265</b> damage, 0 Supercharge. Direct gain +132,497, against roughly one lost pop (−121,077). <b>Net: +11,420 over the whole fight</b> — a wash, well inside the crit-variance range already visible across the four real Full Auto instances.</p>
          <p>Extend the swap into cycles that <em>do</em> have an Explosive Round available (ten more rows), and the math flips hard: about +130,000 direct gain, but 30 Supercharge points lost — roughly three pops, −363,000. <b>Net: roughly −233,000.</b> There's a real but narrow ceiling on "use Full Auto more" — it costs almost nothing right up until it starts displacing an actual proc'd Explosive Round, at which point it's a clear loss.</p>
        </div>
